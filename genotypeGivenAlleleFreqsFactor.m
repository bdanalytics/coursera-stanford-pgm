...
for rowIx = 1:size(allelesToGenotypes)(1),
	for colIx = 1:size(allelesToGenotypes)(2),
		genotypeId = allelesToGenotypes(rowIx, colIx);
		genotypeFactor.val(genotypeId) += alleleFreqs(rowIx) * alleleFreqs(colIx);
	end;	
end;
